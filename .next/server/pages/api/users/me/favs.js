...
async function handler(req, res) {
    ...
    const favs = await _libs_server_client__WEBPACK_IMPORTED_MODULE_0__/* ["default"].fav.findMany */ .Z.fav.findMany({
        where: {
            userId: user?.id
        }
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [534,17], () => (__webpack_exec__(1251)));
