...
async function handler(req, res) {
    ...
    const foundToken = await _libs_server_client__WEBPACK_IMPORTED_MODULE_0__/* ["default"].token.findUnique */ .Z.token.findUnique({
        where: {
            payload: token
        }
    });
    ...
    await _libs_server_client__WEBPACK_IMPORTED_MODULE_0__/* ["default"].token.deleteMany */ .Z.token.deleteMany({
        where: {
...
var __webpack_exports__ = __webpack_require__.X(0, [534,17], () => (__webpack_exec__(7993)));
