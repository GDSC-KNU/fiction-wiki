  ...
  */
  ...
  export type FictionGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'categories' ? Array < CategoriesOnFictionsGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'keywords' ? Array < KeywordsOnFictionsGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'fictionStat' ? FictionStatGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'userFictionStat' ? UserFictionStatGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'user' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'favs' ? Array < FavGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'comments' ? Array < CommentGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'author' ? AuthorGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends '_count' ? FictionCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'categories' ? Array < CategoriesOnFictionsGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'keywords' ? Array < KeywordsOnFictionsGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'fictionStat' ? FictionStatGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'userFictionStat' ? UserFictionStatGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'favs' ? Array < FavGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'comments' ? Array < CommentGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'author' ? AuthorGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends '_count' ? FictionCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Fiction ? Fiction[P] : never
  } 
    : Fiction
  : Fiction
  ...
  export interface FictionDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Fiction'> extends True ? CheckSelect<T, Prisma__FictionClient<Fiction>, Prisma__FictionClient<FictionGetPayload<T>>> : CheckSelect<T, Prisma__FictionClient<Fiction | null, null>, Prisma__FictionClient<FictionGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Fiction'> extends True ? CheckSelect<T, Prisma__FictionClient<Fiction>, Prisma__FictionClient<FictionGetPayload<T>>> : CheckSelect<T, Prisma__FictionClient<Fiction | null, null>, Prisma__FictionClient<FictionGetPayload<T> | null, null>>
  ...
  export class Prisma__FictionClient<T, Null = never> implements PrismaPromise<T> {
    ...
    categories<T extends CategoriesOnFictionsFindManyArgs = {}>(args?: Subset<T, CategoriesOnFictionsFindManyArgs>): CheckSelect<T, PrismaPromise<Array<CategoriesOnFictions>| Null>, PrismaPromise<Array<CategoriesOnFictionsGetPayload<T>>| Null>>;

    keywords<T extends KeywordsOnFictionsFindManyArgs = {}>(args?: Subset<T, KeywordsOnFictionsFindManyArgs>): CheckSelect<T, PrismaPromise<Array<KeywordsOnFictions>| Null>, PrismaPromise<Array<KeywordsOnFictionsGetPayload<T>>| Null>>;
    ...
    favs<T extends FavFindManyArgs = {}>(args?: Subset<T, FavFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Fav>| Null>, PrismaPromise<Array<FavGetPayload<T>>| Null>>;
  ...
  export type AuthorGetPayload<
    ...
    ? Author  & {
    [P in TrueKeys<S['include']>]:
        P extends 'fictions' ? Array < FictionGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? AuthorCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'fictions' ? Array < FictionGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export interface AuthorDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Author'> extends True ? CheckSelect<T, Prisma__AuthorClient<Author>, Prisma__AuthorClient<AuthorGetPayload<T>>> : CheckSelect<T, Prisma__AuthorClient<Author | null, null>, Prisma__AuthorClient<AuthorGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Author'> extends True ? CheckSelect<T, Prisma__AuthorClient<Author>, Prisma__AuthorClient<AuthorGetPayload<T>>> : CheckSelect<T, Prisma__AuthorClient<Author | null, null>, Prisma__AuthorClient<AuthorGetPayload<T> | null, null>>
  ...
  export class Prisma__AuthorClient<T, Null = never> implements PrismaPromise<T> {
    ...
    fictions<T extends FictionFindManyArgs = {}>(args?: Subset<T, FictionFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Fiction>| Null>, PrismaPromise<Array<FictionGetPayload<T>>| Null>>;
  ...
  export type FictionStatGetPayload<
    ...
    ? FictionStat  & {
    [P in TrueKeys<S['include']>]:
        P extends 'fiction' ? FictionGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'fiction' ? FictionGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof FictionStat ? FictionStat[P] : never
  } 
    : FictionStat
  : FictionStat
  ...
  export interface FictionStatDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'FictionStat'> extends True ? CheckSelect<T, Prisma__FictionStatClient<FictionStat>, Prisma__FictionStatClient<FictionStatGetPayload<T>>> : CheckSelect<T, Prisma__FictionStatClient<FictionStat | null, null>, Prisma__FictionStatClient<FictionStatGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'FictionStat'> extends True ? CheckSelect<T, Prisma__FictionStatClient<FictionStat>, Prisma__FictionStatClient<FictionStatGetPayload<T>>> : CheckSelect<T, Prisma__FictionStatClient<FictionStat | null, null>, Prisma__FictionStatClient<FictionStatGetPayload<T> | null, null>>
  ...
  export type UserFictionStatGetPayload<
    ...
    ? UserFictionStat  & {
    [P in TrueKeys<S['include']>]:
        P extends 'fiction' ? FictionGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'users' ? Array < UserGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'userRationOnFictions' ? Array < UserRationOnFictionGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? UserFictionStatCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'fiction' ? FictionGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'users' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'userRationOnFictions' ? Array < UserRationOnFictionGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? UserFictionStatCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof UserFictionStat ? UserFictionStat[P] : never
  } 
    : UserFictionStat
  : UserFictionStat
  ...
  export interface UserFictionStatDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'UserFictionStat'> extends True ? CheckSelect<T, Prisma__UserFictionStatClient<UserFictionStat>, Prisma__UserFictionStatClient<UserFictionStatGetPayload<T>>> : CheckSelect<T, Prisma__UserFictionStatClient<UserFictionStat | null, null>, Prisma__UserFictionStatClient<UserFictionStatGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'UserFictionStat'> extends True ? CheckSelect<T, Prisma__UserFictionStatClient<UserFictionStat>, Prisma__UserFictionStatClient<UserFictionStatGetPayload<T>>> : CheckSelect<T, Prisma__UserFictionStatClient<UserFictionStat | null, null>, Prisma__UserFictionStatClient<UserFictionStatGetPayload<T> | null, null>>
  ...
  export class Prisma__UserFictionStatClient<T, Null = never> implements PrismaPromise<T> {
    ...
    userRationOnFictions<T extends UserRationOnFictionFindManyArgs = {}>(args?: Subset<T, UserRationOnFictionFindManyArgs>): CheckSelect<T, PrismaPromise<Array<UserRationOnFiction>| Null>, PrismaPromise<Array<UserRationOnFictionGetPayload<T>>| Null>>;
  ...
  export type KeywordGetPayload<
    ...
    ? Keyword  & {
    [P in TrueKeys<S['include']>]:
        P extends 'fictions' ? Array < KeywordsOnFictionsGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? KeywordCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'fictions' ? Array < KeywordsOnFictionsGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? KeywordCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Keyword ? Keyword[P] : never
  } 
    : Keyword
  : Keyword
  ...
  export class Prisma__KeywordClient<T, Null = never> implements PrismaPromise<T> {
    ...
    fictions<T extends KeywordsOnFictionsFindManyArgs = {}>(args?: Subset<T, KeywordsOnFictionsFindManyArgs>): CheckSelect<T, PrismaPromise<Array<KeywordsOnFictions>| Null>, PrismaPromise<Array<KeywordsOnFictionsGetPayload<T>>| Null>>;
  ...
  export type KeywordsOnFictionsGetPayload<
    ...
    ? KeywordsOnFictions  & {
    [P in TrueKeys<S['include']>]:
        P extends 'fiction' ? FictionGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'keyword' ? KeywordGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'fiction' ? FictionGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'keyword' ? KeywordGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof KeywordsOnFictions ? KeywordsOnFictions[P] : never
  } 
    : KeywordsOnFictions
  : KeywordsOnFictions
  ...
  export type CategoryGetPayload<
    ...
    ? Category  & {
    [P in TrueKeys<S['include']>]:
        P extends 'fictions' ? Array < CategoriesOnFictionsGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? CategoryCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'fictions' ? Array < CategoriesOnFictionsGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__CategoryClient<T, Null = never> implements PrismaPromise<T> {
    ...
    fictions<T extends CategoriesOnFictionsFindManyArgs = {}>(args?: Subset<T, CategoriesOnFictionsFindManyArgs>): CheckSelect<T, PrismaPromise<Array<CategoriesOnFictions>| Null>, PrismaPromise<Array<CategoriesOnFictionsGetPayload<T>>| Null>>;
  ...
  export type CategoriesOnFictionsGetPayload<
    ...
    [P in TrueKeys<S['select']>]:
        P extends 'fiction' ? FictionGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'category' ? CategoryGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof CategoriesOnFictions ? CategoriesOnFictions[P] : never
  } 
    : CategoriesOnFictions
  : CategoriesOnFictions
  ...
  export interface CategoriesOnFictionsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'CategoriesOnFictions'> extends True ? CheckSelect<T, Prisma__CategoriesOnFictionsClient<CategoriesOnFictions>, Prisma__CategoriesOnFictionsClient<CategoriesOnFictionsGetPayload<T>>> : CheckSelect<T, Prisma__CategoriesOnFictionsClient<CategoriesOnFictions | null, null>, Prisma__CategoriesOnFictionsClient<CategoriesOnFictionsGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'CategoriesOnFictions'> extends True ? CheckSelect<T, Prisma__CategoriesOnFictionsClient<CategoriesOnFictions>, Prisma__CategoriesOnFictionsClient<CategoriesOnFictionsGetPayload<T>>> : CheckSelect<T, Prisma__CategoriesOnFictionsClient<CategoriesOnFictions | null, null>, Prisma__CategoriesOnFictionsClient<CategoriesOnFictionsGetPayload<T> | null, null>>
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'fictions' ? Array < FictionGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'fav' ? Array < FavGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'ratedFictions' ? Array < UserFictionStatGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'userRationOnFictions' ? Array < UserRationOnFictionGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'fictions' ? Array < FictionGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'fav' ? Array < FavGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'ratedFictions' ? Array < UserFictionStatGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'userRationOnFictions' ? Array < UserRationOnFictionGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    fav<T extends FavFindManyArgs = {}>(args?: Subset<T, FavFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Fav>| Null>, PrismaPromise<Array<FavGetPayload<T>>| Null>>;

    ratedFictions<T extends UserFictionStatFindManyArgs = {}>(args?: Subset<T, UserFictionStatFindManyArgs>): CheckSelect<T, PrismaPromise<Array<UserFictionStat>| Null>, PrismaPromise<Array<UserFictionStatGetPayload<T>>| Null>>;
  ...
  export type UserRationOnFictionGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'user' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'userFictionStat' ? UserFictionStatGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'userFictionStat' ? UserFictionStatGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof UserRationOnFiction ? UserRationOnFiction[P] : never
  } 
    : UserRationOnFiction
  : UserRationOnFiction
  ...
  export interface UserRationOnFictionDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'UserRationOnFiction'> extends True ? CheckSelect<T, Prisma__UserRationOnFictionClient<UserRationOnFiction>, Prisma__UserRationOnFictionClient<UserRationOnFictionGetPayload<T>>> : CheckSelect<T, Prisma__UserRationOnFictionClient<UserRationOnFiction | null, null>, Prisma__UserRationOnFictionClient<UserRationOnFictionGetPayload<T> | null, null>>
  ...
  export type FavGetPayload<
    ...
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'fiction' ? FictionGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Fav ? Fav[P] : never
  } 
    : Fav
  : Fav
  ...
  export interface FavDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Fav'> extends True ? CheckSelect<T, Prisma__FavClient<Fav>, Prisma__FavClient<FavGetPayload<T>>> : CheckSelect<T, Prisma__FavClient<Fav | null, null>, Prisma__FavClient<FavGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Fav'> extends True ? CheckSelect<T, Prisma__FavClient<Fav>, Prisma__FavClient<FavGetPayload<T>>> : CheckSelect<T, Prisma__FavClient<Fav | null, null>, Prisma__FavClient<FavGetPayload<T> | null, null>>
  ...
  export type CommentGetPayload<
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'fiction' ? FictionGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Comment ? Comment[P] : never
  } 
    : Comment
  : Comment
