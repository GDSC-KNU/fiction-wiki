...
const Home: NextPage<{ fictions: FictionWithMore[] }> = ({ fictions }) => {
  ...
  // const [china, korea, japan] = ["as","as","sa"]
  ...
  return (
    <div>
      ...
      <div className=" sm:hidden">
        <section className="">
          <div className="mt-5 font-bold text-xl">평점 TOP 5</div>
          <ul className=" flex-col w-96 grid grid-cols-4">
            {top_total?.slice(0, 5).map((fiction, i) => (
              <Link key={fiction.id} href={`/fictions/${fiction.id}`}>
                <li className=" flex-col w-[100] h-[190] my-3 mx-1 cursor-pointer bg-white border-[0.5px] border-[#BBBBBB] rounded-md overflow-hidden">
                  <div className=" relative w-[96px] h-[128px] mb-1">
                    <Image
                      className=""
                      src={`https://imagedelivery.net/vZ0h3NOKMe-QsJIVyNemEg/${fiction.image}/fiction`}
                      layout="fill"
                  ...
                  <div className=" flex-col px-1 pb-2">
                    <div className=" flex justify-between">
                      <div className=" text-xs text-gray-400">
                        {fiction.genre}
                      </div>
