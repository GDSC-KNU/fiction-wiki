  ...
  return (
    <div className=" flex justify-center">
      {props.type === "fictions_list" ? (
        <div>
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-1 py-2">
            {props?.data?.fictions?.map(
              (fiction: FictionWithMore, i: number) => (
                <div
                  key={fiction.id}
                  className=" relative flex my-3 mx-1 bg-white border-[#BBBBBB] rounded-md "
                >
                  ...
                  <div className=" flex-col px-2 pb-2">
                    ...
                    <h3>
                      <Link href={`/fictions/${fiction.id}`}>
                        <a className=" cursor-pointer hover:underline font-bold ">
                          {fiction.title}
                        </a>
                      </Link>
                    </h3>
                    ...
                    <p className=" max-h-[24px] overflow-hidden mt-1">
                      {fiction?.keywords?.map((keyword, i) => (
                        <Link
                          key={i}
                          href={`/search/keyword/${keyword.keyword.name}`}
                        >
                          <span className=" hover:underline cursor-pointer whitespace-nowrap bg-gray-200 text-[#666676] peer-checked:bg-blue-600 peer-checked:text-white  hover:border-gray-400 hover:bg-gray-200 mt-1 text-sm text-center mr-[0.35rem] rounded-3xl border-[#BBBBBB] p-[0.2rem]">
                    ...
                    <p className="  text-xs font-bold mt-1">
                      <span className=" flex">
                        <span className=" flex w-20 text-xs">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="14"
                            height="14"
            ...
            {props?.data?.fictions?.map(
              (fiction: FictionWithMore, i: number) => (
                ...
                >
                  <Link href={`/fictions/${fiction.id}`}>
                    {(fiction.image && (
                      <div className=" relative w-[108px] h-[166px] min-w-[108px]">
                        <Image
                          className=" cursor-pointer"
                          src={`https://imagedelivery.net/vZ0h3NOKMe-QsJIVyNemEg/${fiction.image}/fiction`}
                          layout="fill"
                    ...
                    )) || <div className=" w-[142px] h-[199.69px]"></div>}
                  </Link>
                  <div className=" ml-1 absolute z-10">
                    {fiction.nationality === "중국" ? (
                      <svg
                  ...
                  <div className=" flex-col px-2 pb-2">
                    ...
                    {/* <p className=" text-xs text-gray-400">{fiction.genre}</p> */}
                    <h3 className=" font-bold">{fiction.title}</h3>
                    <p className=" text-xs">
                      {"by "}
                      {fiction.author?.name || "작자 미상"}
                    </p>
                    <p className=" max-h-[24px] overflow-hidden mt-1">
                      {fiction?.keywords?.map((keyword, i) => (
                        <Link
                          ...
                          href={`/search/keyword/${keyword.keyword.name}`}
                        >
                          <span className=" cursor-pointer whitespace-nowrap bg-gray-200 text-[#666676] peer-checked:bg-blue-600 peer-checked:text-white  hover:border-gray-400 hover:bg-gray-200 mt-1 text-sm text-center mr-[0.35rem] rounded-3xl border-[#BBBBBB] p-[0.2rem]">
                            #{keyword.keyword.name}
                          </span>
                        </Link>
                      ))}
